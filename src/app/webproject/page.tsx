...
export default function WebProjectSection() {
  ...
  const projects = [
...

    {
      title: "HI-Toyz",
      description:
        "HI-Toyz is a campus project where I was tasked with designing a website prototype and developing the official company website for a toy store specializing in plastic model kits and figure statues. The store, known for being an official reseller of brands like Tamiya, Bandai, and Mattel, aims to expand its market by selling products online to a global audience. This project focuses on creating a website that reflects the identity of store and improves customer service.",
      imgUrl: toyz,
      href: "",
      year: "2023",

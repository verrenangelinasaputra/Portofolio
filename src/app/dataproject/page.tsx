  ...
  const projects = [
    {
      ...
      description:
        "An environmental data visualization project that won 3rd place at the DAIC 2024 competition. This infographic explores dominant role of Asia in global CO₂ emissions, highlighting top contributors like China and Indonesia, and emphasizes the urgency of sustainable action to combat climate change.",
      imgUrl: daic,
      href: "",
      year: "2024",
